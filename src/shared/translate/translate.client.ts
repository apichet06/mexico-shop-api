...
export const translator = new deepl.Translator(authKey, {
    // Si es una Free key, la petición va a api-free (algunas versiones lo eligen automáticamente) (ถ้าเป็น Free key จะยิงไป api-free (บางเวอร์ชันเลือกเองอัตโนมัติ))
